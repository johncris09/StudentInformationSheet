...
namespace Student
{
    public partial class Form1 : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from Student where Last_Name  like '%" + textBox1.Text + "%' OR First_Name like '%" + textBox1.Text + "%' OR Middle_Name like '%" + textBox1.Text + "%' OR Sex like '%" + textBox1.Text + "%' OR Age like '%" + textBox1.Text + "%' OR Mailing_Address like '%" + textBox1.Text + "%' OR Mailing_Address_Phone_Number like '%" + textBox1.Text + "%' OR City like '%" + textBox1.Text + "%' OR City_Phone_Number like '%" + textBox1.Text + "%' OR Citizenship like '%" + textBox1.Text + "%' OR Religion like '%" + textBox1.Text + "%' OR BirthDate like '%" + textBox1.Text + "%' OR BirthPlace like '%" + textBox1.Text + "%' OR Status like '%" + textBox1.Text + "%' OR Guardians_Name like '%" + textBox1.Text + "%' OR Guardians_Phone_Number like '%" + textBox1.Text + "%' OR Parents_Phone_Number like '%" + textBox1.Text + "%' OR Parents_Name like '%" + textBox1.Text + "%' OR Street like '%" + textBox1.Text + "%' OR Barangay like '%" + textBox1.Text + "%' OR City_Address like '%" + textBox1.Text + "%' OR Province like '%" + textBox1.Text + "%' OR School_Name_In_Elementary like '%" + textBox1.Text + "%' OR Date_Graduated_in_Elementary like '%" + textBox1.Text + "%' OR School_Name_In_Secondary like '%" + textBox1.Text + "%' OR Date_Graduated_In_Secondary like '%" + textBox1.Text + "%' OR School_Name_In_College like '%" + textBox1.Text + "%' OR Date_Graduated_In_College like '%" + textBox1.Text + "%' OR School_Name_In_College_Course_Taken like '%" + textBox1.Text + "%' OR Date_Graduated_In_Course_Taken like '%" + textBox1.Text + "%' OR SchoolName_1 like '%" + textBox1.Text + "%' OR CourseEnrolled_1 like '%" + textBox1.Text + "%' OR SchoolName2 like '%" + textBox1.Text + "%' OR Semester1 like '%" + textBox1.Text + "%' OR CourseEnrolled2 like '%" + textBox1.Text + "%' OR Semester2 like '%" + textBox1.Text + "%' OR SchoolName3 like '%" + textBox1.Text + "%' OR CourseEnrolled3 like '%" + textBox1.Text + "%' OR Semester3 like '%" + textBox1.Text + "%' OR OrganizationName1 like '%" + textBox1.Text + "%' OR Term1 like '%" + textBox1.Text + "%' OR PositionHeld1 like '%" + textBox1.Text + "%' OR ActivityTItle1 like '%" + textBox1.Text + "%' OR OrganizationName2 like '%" + textBox1.Text + "%' OR PositionHeld2 like '%" + textBox1.Text + "%' OR Term2 like '%" + textBox1.Text + "%' OR OrganizationName3 like '%" + textBox1.Text + "%' OR PositionHeld3 like '%" + textBox1.Text + "%' OR Term3 like '%" + textBox1.Text + "%' OR Sponsor1 like '%" + textBox1.Text + "%' OR InclusiveDate1 like '%" + textBox1.Text + "%' OR ActivityTitle2 like '%" + textBox1.Text + "%' OR Sponsor2 like '%" + textBox1.Text + "%' OR InclusiveDate2 like '%" + textBox1.Text + "%' OR ActivityTitle3 like '%" + textBox1.Text + "%' OR Sponsor3 like '%" + textBox1.Text + "%' OR InclusiveDate3 like '%" + textBox1.Text + "%' OR Student_ID like '%" + textBox1.Text + "%'";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            OleDbDataAdapter da = new OleDbDataAdapter(cmd);
            da.Fill(dt);
